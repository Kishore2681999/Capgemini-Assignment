...
public class Assg8_1 {
    public static void main(String[] args) {
        ...
        System.out.println("Difference: "+s.operation(8,3));

        Arthemetic m = (int val1, int val2)->val1*val2;
        System.out.println("Product: "+m.operation(8,3));

        Arthemetic d = (int val1, int val2)->val1/val2;
        System.out.println("Division result: "+d.operation(8,3));
    }
}